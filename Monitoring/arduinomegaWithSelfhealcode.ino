...
float voltageph, phValue, totalPH, averagePH, readingsPH[NUM_READINGS];
int readIndexPH = 0;
DFRobot_PH ph;
...
String kirim;
int pHrelaypin = 31, ECrelaypin = 29, pomparelay = 27, h, reset_count = 0;
   ...
   switch (currentState) {
    ...
    case SAMPLING_PH:
      for (h = 0; h <= 25; h++) {
        ...
        if (millis() - timepoint > 1000U) {  // interval waktu: 2 detik
          timepoint = millis();
